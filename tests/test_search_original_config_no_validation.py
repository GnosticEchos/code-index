#!/usr/bin/env python3
"""
Test search with the original configuration (modified timeout).
"""
import os
import sys
...
def test_search():
    ...
    config.embed_timeout_seconds = 10
    ...
    # Generate embedding for query directly (skip validation which seems to timeout)
    query = "code indexing"
