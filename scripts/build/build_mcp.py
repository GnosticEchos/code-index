...
def build_mcp_binary():
    ...
    print("Building Universal Structural Intelligence MCP binary...")
    if run_command(cmd, "Building MCP binary"):
        print("MCP binary built successfully: dist/code-index-mcp")
    else:
        sys.exit(1)
